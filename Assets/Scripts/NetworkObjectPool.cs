...
namespace Unity.BossRoom.Infrastructure
{
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        Dictionary<GameObject, int> non_m_PooledObjects = new Dictionary<GameObject,int>();
        ...
        public  void InitializePool()
        {
            ...
            {   
                non_m_PooledObjects[configObject.Prefab] = 0;
        ...
        {
             return non_m_PooledObjects[prefab];
        }
        /// <summary>
